...
def _(df_line, df_para, np, pd):
    ...
    # Usage example:
    results_1 = evaluate_object_detection(df_para, df_line, iou_threshold=0.5)
    results_2 = evaluate_object_detection(df_line, df_para, iou_threshold=0.5)

    # Create comparison table
    comparison = results_to_dataframe({
        'GT: Line, Pred: Para': results_1,
        'GT: Para, Pred: Line': results_2,
    })
