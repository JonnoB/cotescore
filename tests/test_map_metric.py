...
class TestMAPMetric:
    ...
    def test_no_overlap(self):
        ...
        preds = [{"x": 10, "y": 10, "width": 20, "height": 20, "class": "text", "confidence": 1.0}]

        gt = [{"x": 100, "y": 100, "width": 20, "height": 20, "class": "text"}]
    ...
    def test_class_mismatch(self):
        ...
        gt = [{"x": 10, "y": 10, "width": 50, "height": 50, "class": "text"}]
    ...
    def test_partial_match(self):
        ...
        preds = [{"x": 15, "y": 15, "width": 50, "height": 50, "class": "text", "confidence": 1.0}]
